...
/* harmony import */ var _movie__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./movie */ "./src/movie.js");
/* harmony import */ var _plugins_init_sortable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./plugins/init_sortable */ "./src/plugins/init_sortable.js");
...
application.load(Object(stimulus_webpack_helpers__WEBPACK_IMPORTED_MODULE_1__["definitionsFromContext"])(context)); // imports


 // element selection

var submit = document.querySelector("#submit"); // functions calls

Object(_movie__WEBPACK_IMPORTED_MODULE_2__["fetchAPI"])("Jaws");
Object(_plugins_init_sortable__WEBPACK_IMPORTED_MODULE_3__["initSortable"])(); // event handling

submit.addEventListener("click", _movie__WEBPACK_IMPORTED_MODULE_2__["searchMovie"]);
...
/*!**********************!*\
  !*** ./src/movie.js ***!
  \**********************/
/*! exports provided: fetchAPI, searchMovie */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var displayMovies = function displayMovies(movies) {
  ...
  movies.forEach(function (movie) {
    results.insertAdjacentHTML("beforeend", "<li class='list-inline-item'>\n        <img height=\"120\" src=".concat(movie.Poster, " alt=\"movie\">\n      </li>"));
  });
};

var fetchAPI = function fetchAPI(keyword) {
...
var searchMovie = function searchMovie(event) {
...
var initSortable = function initSortable() {
  ...
  sortablejs__WEBPACK_IMPORTED_MODULE_0__["default"].create(ulElement, {
    ghostClass: "ghost",
